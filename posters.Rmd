...
- You can create bautiful poster using PowerPoint but I encourage you to use <span class="latex">L<sup>A</sup>T<sub>E</sub>X</span>. You can find a template [here](https://github.com/GarciaRios/govt_6029/tree/master/Labs/lab7/poster). 
    ...
    - This is just a template, you do not have to create one exaclty like this one. Feel free to move things around
