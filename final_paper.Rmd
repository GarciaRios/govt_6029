...
I have moved the deadline for the final paper to  **Monday, May  20, 11:59 pm**.

Submit a copy of the paper and all associated code and data necessary to produce the results of the paper (see rule 7) via Balckboard
...
3. Except in cases of family or medical emergency, I will not grant incompletes.
   ...
   15 weeks work, not a year, so turn in what you can accomplish in 15 weeks to get interim feedback, even if your ultimate research aims are broader than a term assignment.
...
Put everything (inlcuding the paper, simlified data and  code) in a compresssed file (e.g: .zip, .rar or .tar) and submit that compressed filed   
