...
On your own, make sure your lab compiles neatly.Make sure that you are not printing unnecessary output. 

On the class website, you can find the RMarkdown code that use to create this document. Download it and check the code that use to keep it nice and clean as well and the Markdown code that use through the text (e.g to create lists and other styling)
