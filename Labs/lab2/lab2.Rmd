...
- Manipulate data using the verbs in the **dplyr**
- Use the pipe operator `%>%` to simplify complicated code by chaining expressions together
- Create plots using the ggplot2 package.
...
1.
  **Challenge**
    ...
    - Explore the dimensions of the dataset and it's variables
...
### Exploratory Analysis with (`ggplot`)Graphs  
