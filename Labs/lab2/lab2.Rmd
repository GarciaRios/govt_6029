...
```{r load-template}
download.file("https://github.com/GarciaRios/govt_6029/raw/gh-pages/Labs/lab2/lab_2.Rmd", destfile = "lab_2.Rmd")
```
...
What about life expectancy? Create a relative a variable  to life expectancy variable, compare the three NAFTA countries US, Canada and Mexico
