---
title: "Lab 1: Introduction to R, RStudio and knitr"
output:
  html_document:
    theme: simplex
    highlight: haddock
...
knitr::opts_chunk$set(results = "hide", warning = FALSE, message = FALSE, echo = T,
                      fig.show = "hide")
```
...
3. How many countries in the data are there? How many years?
    a. The function `length()` calculates the length of a vector.
    b. The function `unique()` returns the number of unique values in a vector.
