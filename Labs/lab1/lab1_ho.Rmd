...
You can see which datasets are included in a package. gapminder is not the only one most packages have some data set whithin the package. See also for instance `ggplot2`
```{r eval=FALSE}
