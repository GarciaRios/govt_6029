...
You can  embed code for class material. And for the Figures and captions notice that in the code  I use  `\\label{fig:plot}` in the title which add .tex code to which can latter be called inside the caption of another Figure.
