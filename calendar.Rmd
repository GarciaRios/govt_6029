...
- **January 28**  Intro to the course  [Deck 1](lectures/Lecture_01_handout.pdf)
...
- **February 18**  Review, Properties and Assumptions, Matrix Form [Deck 2](lectures/Lecture_02_handout.pdf)
    - Readings: 
...
- **February 25**  February Break 
    - No  Class
- **March 4**  Lab 3:  Linear Regression, Matrices, and predicted Values
    - Lab document: [html](Labs/lab3/lab3.html)
    - Probelm Set 2 Assigned, Due March 15
...
- **March 11**  Lecture  [Deck 3](lectures/Lecture_03_handout.pdf)
    - [Sampling Distribution of linear regression example]()
    - [Multiple regression coefficient anatomy]()


- **March 18** Lab 4: Multivariate Linear Regression, and Predicted Values
...
- **March 25** Lecture  [Deck 4](lectures/Lecture_03_handout.pdf)

-  **April 1**  Sprnig break
    - No class



- **March 25** Lecture  [Deck 4](lectures/Lecture_05_handout.pdf)


- **April 8**   Lab 5  Loops and simulation
...
- **April 15** Lecture  [Deck 5](lectures/Lecture_05_handout.pdf)

- **April 22** Lab 6: Binary Models and Data Wrangling
    - Lab document: [html](Labs/lab6/BinaryModelsAndDataWrangling.R)

- **April 29** Lab 7: Case Study
    - Lab document: [html](Labs/lab6/BinaryModelsAndDataWrangling.R)
...
- **May 6** One-on-One Consultation for Final Projects
- **May 15** Poster Presentation: 10:00 am
