...
- **February 8**  Intro to the course  [Deck 1](lectures/Lecture_01.pdf)
...
- **February 15** Lab 1: Introduction to R, RStudio and knitr
...
- **March 1** Lab 2: Graphing and Data Manipulation
...
- **March 8**  Review, Properties and Assumptions, Matrix Form [Deck 2](lectures/Lecture_02.pdf)
    - Readings: 
        - Matrix algebra [handout](docs/matrix.pdf)
        


- **March 15**  Lab 3:  Linear Regression, Matrices, and predicted Values
...
- **March 22**  Lecture  [Deck 3](lectures/Lecture_02.pdf)
...
- **March 29** Lab 4: Multivariate Linear Regression, and Predicted Values
...
- **April 5** Lecture  [Deck 4](lectures/lecture4.pdf)


- **April 12**   Lab 5  Loops and simulation
...
- **April 19** Lecture  [Deck 5](lectures/lecture5.pdf)]
