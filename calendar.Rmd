...
- <i class="fa fa-book"></i> **February 8**   Intro to the course  [Deck 1](lectures/Lecture_01.pdf)
...
- <i class="fa fa-flask"></i>  **February 15** Lab 1: Introduction to R, RStudio and knitr
...
- <i class="fa fa-book"></i>  **February 22** Review, Matrix Form [Deck 2](lectures/Lecture_02.pdf@)
    - Readings: 
        - Matrix algebra [handout](docs/matrix.pdf)
 
 
-  <i class="fa fa-flask"></i> **March 1** Lab 2: Graphing and Data Manipulation
    ...
    - Problem Set 1 Assigned, Due Mar 10
...
- <i class="fa fa-book"></i> **March 8**  Properties and Assumptions, [Deck 3](lectures/Lecture_03_upd21.pdf@)
        - [Sampling Distribution of linear regression example](https://www.econometrics-with-r.org/4-5-tsdotoe.html)



-  <i class="fa fa-flask"></i> **March 15**   Lab 3:  Linear Regression, Matrices, and predicted Values
...
probability and statistics](docs/gelman_hill_ch2.pdf)
    - Problem Set 2 Assigned, Due March 24
        

-  <i class="fa fa-flask"></i> **March 22** Lab 4: Multivariate Linear Regression, and Predicted Values
...
- **March 29** Inference and Interpretation of Linear Regression [Deck 4](lectures/lecture4.pdf@)


- <i class="fa fa-flask"></i>  **April 5**   Lab 5  Loops and simulation 
    - Lab document: [html](Labs/lab5/lab5.html)
    - Problem Set 3 Assigned, Due Apr 14

-  <i class="fa fa-book"></i> **April 12** Specification, Bias,  and Transformations [Deck 5](lectures/lecture5.pdf@)
...
- <i class="fa fa-flask"></i>  **May 19** Lab 6: Binary Models and Data Wrangling
    - Lab document: [html](Labs/lab6/BinaryModelsAndDataWrangling.R)
     - Problem Set 4, Due Apr 28

- **April 26**  Wellness Day 
       - No  Class


- <i class="fa fa-flask"></i>  **May 3** Lab 7: Case Study
    - Lab document: [html](Labs/lab6/BinaryModelsAndDataWrangling.R)


- **May 10-12-** Final Project Consulting 
