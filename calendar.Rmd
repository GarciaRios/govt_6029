...
-  <i class="fa fa-flask"></i> **March 1** Lab 2: Graphing and Data Manipulation
    ...
    - Problem Set 1 Assigned, Due Mar 12
...
- <i class="fa fa-book"></i> **March 8**  Properties and Assumptions, [Deck 3](lectures/Lecture_03.pdf)
...
- <i class="fa fa-book"></i>  **March 22** Inference and Interpretation of Linear Regression [Deck 4](lectures/lecture4.pdf@)


-  <i class="fa fa-flask"></i> **March 29** Lab 4: Multivariate Linear Regression, and Predicted Values
    - Lab document: [html](Labs/lab4/lab4.html)


-  <i class="fa fa-book"></i> **April 5** Specification, Bias,  and Transformations [Deck 5](lectures/lecture5.pdf@)



- <i class="fa fa-flask"></i>  **April 12**   Lab 5  Loops and simulation 
    - Lab document: [html](Labs/lab5/lab5.html)
    - Problem Set 3 Assigned, Due Apr 21
...
- <i class="fa fa-flask"></i>  **April 19** Lab 6: Binary Models and Data Wrangling
