...
#### **Assumptions & Properties of the Linear Regression Model, Part II**
 ...
 -  **March 16 23**  Classes suspended 



- **April 6** Lecture  [Deck 4](lectures/lecture4.pdf)


- **April 16**   Lab 5  Loops and simulation
    - Lab document: [html](Labs/lab5/lab5.html)
    - Problem Set 3 Assigned, Due May 7

***

#### **Inference and Interpretation of Linear Regression**

- **April 23** Lecture  [Deck 5](lectures/Lecture_05_handout.pdf)

- **April 30** Lab 6: Binary Models and Data Wrangling
    - Lab document: [html](Labs/lab6/BinaryModelsAndDataWrangling.R)
    - Problem Set 4 Canceled

- **May 7** Lab 7: Case Study
    - Lab document: [html](Labs/lab6/BinaryModelsAndDataWrangling.R)


- **May 11-15** Final Project Consulting
